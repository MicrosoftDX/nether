...
![DAU over Time Graph](../../../images/analytics/DAURecipe/dauovertime.jpg)
...
|------------------------------------|-------------------------------------------|
| [session-start](../../../../src/Nether.Ingest.MessageFormats/SessionStart.cs)      | Send a ```session-start``` message every time a player starts a session in your game |
...
![Success VS](../../../images/analytics/DAURecipe/run.JPG)
![Success Azure](../../../images/analytics/DAURecipe/azureview.JPG)
...
![Result](../../../images/analytics/DAURecipe/result.JPG)
